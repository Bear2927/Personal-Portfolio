      ...
      <div className='flex flex-col justify-center items-center w-full h-full'>
        <div className='max-w-[1000px] w-full grid grid-cols-3 gap-8'>
          ...
          <div className='max-w-[1000px] w-full grid sm:grid-cols-3 gap-8 px-4'>
            ...
            <div className='pl-8'>
              <img src={headshot} alt="headshot" className='border-4 border-violet-900 rounded-3xl h-80 shadow-[#FDEEDC] shadow-lg hover:scale-110 duration-500'/>
            </div>
            <div className='sm:text-left text-base '>
